...
- **协议转换**: 内置 OpenAI ↔ Anthropic ↔ Responses 协议转换器
...
[endpoint.openai.mapping."claude-sonnet"]
target = "openai@claude-sonnet-4-20250514"

[[endpoint.openai.mapping."claude-sonnet".headers]]
name = "X-Custom-Header"
value = "custom-value"

[[endpoint.openai.mapping."claude-sonnet".body]]
